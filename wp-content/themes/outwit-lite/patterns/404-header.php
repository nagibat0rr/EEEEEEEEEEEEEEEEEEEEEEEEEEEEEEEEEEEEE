...
<div class="wp-block-group alignwide"><!-- wp:heading {"level":1,"className":"has-text-color-foreground"} -->
<h1 class="has-text-color-foreground"><?php esc_html_e( '404 Nothing Found', 'outwit-lite' ); ?></h1>
<!-- /wp:heading -->
