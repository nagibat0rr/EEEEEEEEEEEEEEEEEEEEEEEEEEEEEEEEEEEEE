<?php
 /**
  * Title: Recent Blog
  * Slug: outwit-lite/recent-blog
  * Categories: outwit-lite, query
  */
?>
...
<div class="wp-block-group wp-block-widget-area wp-block-sidebar">
	...
	<div class="wp-block-group wp-block-widget about">
		...
		<h2 id="about" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('About','outwit-lite');?></h2>
		<!-- /wp:heading -->
		...
		<p><?php esc_html_e('Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Maecenas odio lacus, dignissim sollicitudin finibus
            commodo, rhoncus et ante.','outwit-lite');?></p>
		<!-- /wp:paragraph -->
		<!-- wp:buttons -->
		<div class="wp-block-buttons">
			<!-- wp:button {"className":"is-style-outline"} -->
			<div class="wp-block-button is-style-outline">
				<a class="wp-block-button__link wp-element-button"><?php esc_html_e('Read More','outwit-lite');?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	...
	<div class="wp-block-group wp-block-widget">
		<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
		<h2 id="recent-post" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Recent Post','outwit-lite');?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
		<h2 id="tags" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Tags','outwit-lite');?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
		<h2 id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Categories','outwit-lite');?></h2>
		<!-- /wp:heading -->
		<!-- wp:categories /-->
	</div>
	<!-- /wp:group -->
